  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 overflow-x-hidden scroll-smooth">
            ...
            <div className="space-y-5">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500 mt-0.5">
                    {isTr
                      ? "Hızlı iletişim için mesaj atın"
                      : "Send a message for quick communication"}
                  </p>
                </div>
              </a>
      ...
      >
        ...
        <span
          className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full flex items-center justify-center text-[8px] text-white font-bold animate-pulse"
          aria-hidden="true"
        >
          1
        </span>
